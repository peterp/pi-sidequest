...
It lets you ask quick side questions without adding noise to the main conversation. Sidequest is grounded in the active Pi session and keeps its own lightweight question threads.
